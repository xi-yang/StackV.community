...
class PullCmdAssembler {
	...
	public String generateCmdStr(HashMap<String, String> pullUtilParams) {
		String cmdStr = pullInvokePattern;
		HashMap<String, String> pullUtilParamsCopy = new HashMap<>();
		shallowCopy(pullUtilParams, pullUtilParamsCopy);
...
//	}
	...
	private static void shallowCopy(HashMap<String, String> src, HashMap<String, String> dst) {
		for (Entry<String, String> content : src.entrySet())
