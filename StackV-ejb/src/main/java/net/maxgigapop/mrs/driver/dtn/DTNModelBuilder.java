...
//    @SuppressWarnings("empty-statement")
    public static OntModel createOntology(String topologyURI, String endpoint, String pullInvokePattern, Map<String, List<Object>> endpointModelConfigMap) throws IOException {
...
//        Resource dataTransfer = Mrs.DataTransfer;
        ...
        for (String ip : endpointModelConfigMap.keySet()) {
        	@SuppressWarnings("unchecked")
			Map<String, String> pullCommandParamMap = (Map<String, String>) endpointModelConfigMap.get(ip).get(0);
            if (ip != null && !ip.isEmpty()) {
                DTNGet conf = new DTNGet(pullInvokePattern, pullCommandParamMap);
