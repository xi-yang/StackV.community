...
<html >    
    <head>   
        ...
        <script src="/vxstack-web/js/svc/hybridcloud.js"></script>
    ...
    <body>
        ...
        <div id="main-pane">           
            <!-- Multistep form -->
            <form action="/vxstack-web/ServiceServlet" method="post" class="stageform" id="msform" onsubmit="return validateHybrid()">
