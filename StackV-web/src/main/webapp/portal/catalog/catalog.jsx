...
class Catalog extends React.Component {
    ...
    reloadModals() {
        let page = this;
        if (!page.props.keycloak.tokenParsed.realm_access.roles.includes("F_Profiles-W")) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (let i = 0; i < result.length; i++) {
                        ...
                        if (owner !== page.props.keycloak.tokenParsed.preferred_username) {
    ...
    initModals() {
        ...
        $catModal.iziModal("setContent", "<div class=\"catalog-modal-body\">" +
            ...
            "</div>");
        $profModal.iziModal("setContent", "<div class=\"profiles-modal-body\">" +
            ...
            "</div>");
        $detailsModal.iziModal("setContent", "<div style=\"height: 80vh;\" class=\"profile-details-modal-body\">" +
            ...
            "</div>");
        $licenseModal.iziModal("setContent", "<div id=\"profile-license-modal-body\" style=\"margin-bottom: 20px;padding: 15px;\"><form class=\"form-horizontal\"><div class=\"form-group profile-license-modal-username\"><label class=\"col-sm-2 control-label\">Username</label>" +
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#profiles-modal-service-meta").on("click", "a", function (evt) {
                    ...
                    page.setState({ openProfile: profileID });
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result["owner"] === page.props.keycloak.tokenParsed.preferred_username
                                || result["editable"] === "1") {
                            ...
                            // Licensee of profile
                                ...
                                for (let i in result["licenses"]) {
                                    ...
                                    if (license["username"] === page.props.keycloak.tokenParsed.preferred_username) {
                                ...
                                if (type === "ticket") {
                                    ...
                                    let apiUrl = window.location.origin + "/StackV-web/restapi/app/profile/" + profileID + "/uses/" + page.props.keycloak.tokenParsed.preferred_username;
                                    $.ajax({
                                        url: apiUrl,
                                        type: "GET",
                                        contentType: "application/json; charset=utf-8",
                ...
                $(".button-profile-delete").on("click", function (evt) {
                    ...
                    $.ajax({
                        ...
                        success: function () {
                            page.setState({ openProfile: undefined });
