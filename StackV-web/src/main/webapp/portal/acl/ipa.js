...
var ipaApiUrl = window.location.origin + "/StackV-web/restapi/app/acl/ipa/request";
...
* @returns {jqXHR}
*/
export function createUserGroup(groupName, desc) {
...
* @returns {jqXHR}
*/
export function addUsersToUserGroup(users,userGroup) {
...
* @returns {undefined}
*/
export function createHost(hostName) {
    // creating the IPA request
...
* @returns {jqXHR}
*/
export function createHostGroup(groupName, desc) {
    // creating the IPA request
    var ipaRequestData = {
...
* @returns {jqXHR}
*/
export function addHostsToHostGroup(hosts, hostGroupName) {
...
* @returns {jqXHR}
*/
export function getHostsForServiceInstance(serviceUUID) {
...
* @returns {jqXHR}
*/
export function createHBACRule(ruleName, desc) {
    // creating the IPA request
    var ipaRequestData = {
        "method":"hbacrule_add",
        "params":[
...
* @returns {jqXHR}
*/
export function addUserGroupToHBACRule(userGroup, hbacRule) {
...
* @returns {jqXHR}
*/
export function addHostGroupToHBACRule(hostGroup, hbacRule) {
...
* @returns {jqXHR}
*/
export function addServicesToHBACRule(services, hbacRule) {
...
* to the hbac rule.
*/
export function createLoginAclPolicy(serviceUUID, username) {
...
* to the hbac rule.
*/
export function createSudoAclPolicy(serviceUUID, username) {
...
* @returns {jqXhr}
*/
export function isUserInAclPolicy(serviceUUID, accessType, username) {
    // creating the IPA request
    /**
...
* @returns {jqXHR}
*/
export function checkForExistingACLPolicy(serviceUUID, accessType) {
...
* @returns {undefined}
*/
export function removeUserFromACLPolicy(username, serviceUUID, accessType) {
...
export function deleteHostGroup(hostgroupName) {
...
export function deleteUserGroup(usergroupName) {
...
export function deleteHBACRule(hbacruleName) {
...
export function removeACLPolicy(serviceUUID, accessType) {
...
* @returns {undefined}
*/
export function removeAllACLPolicies(serviceUUID) {
...
* @returns {String}
*/
export function parseACLPolicyResult(resultJSON) {
    var prettyResults = "";
