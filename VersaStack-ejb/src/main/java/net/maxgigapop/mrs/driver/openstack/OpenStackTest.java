...
import net.maxgigapop.mrs.service.StartServiceTest;
...
public class OpenStackTest {
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(StartServiceTest.class.getName()).log(Level.INFO, "OpenStack driver instance started");
            
        } catch (Exception ex) {
            Logger.getLogger(StartServiceTest.class.getName()).log(Level.SEVERE, ex.getMessage(), ex);
        }
    }
