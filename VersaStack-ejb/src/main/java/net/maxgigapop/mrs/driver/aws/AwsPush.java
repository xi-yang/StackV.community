        ...
        for (String request : requests) {
            if (request.contains("TerminateInstancesRequest")) {
             ...
             else if (request.contains("AttachVolumeRequest")) 
             {
               ...
               volumeRequest.withInstanceId(getResourceId(parameters[1]))
                       .withVolumeId(getResourceId(parameters[2]))
...
//id of the resource
    private String getResourceId(String id) {
        ...
        filter.withName("value")
                .withValues(id,"available","running","in-use");
    ...
    */
    private String attachVolumeRequests(OntModel modelAdd)
    {
        ...
        while(r1.hasNext())
        {
           ...
           {
                String nodeId= getResourceId(nodeTagId);
                String volumeId = getResourceId(volumeTagId);
